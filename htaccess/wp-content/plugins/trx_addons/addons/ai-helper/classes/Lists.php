	...
	class Lists {
		...
		static function get_list_ai_image_models() {
			...
			if ( ! isset( $sd_models['default'] ) ) {
				$sd_models['default'] = esc_html__( 'Stable Diffusion default', 'trx_addons' );
			}
		 ...
		 */
		static function get_list_ai_image_periods() {
			return apply_filters( 'trx_addons_filter_ai_helper_list_ai_image_periods', array(
