...
if ( ! function_exists('preservation_get_not_selected_text') ) {
	/**
	 ...
	 */
	function preservation_get_not_selected_text( $label ) {
		return apply_filters( 'preservation_filter_not_selected_text',
								sprintf( apply_filters( 'preservation_filter_not_selected_mask', __( '- %s -', 'preservation' ) ), $label )
							);
	}
}

if ( ! function_exists( 'preservation_get_list_range' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'preservation_get_list_styles' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'preservation' ), $i );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'preservation' ),
			'no'  => esc_html__( 'No', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function preservation_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'preservation' ),
				0         => esc_html__( 'No', 'preservation' ),
			)
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'preservation_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'preservation' ),
			'off' => esc_html__( 'Off', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'preservation' ),
			'hide' => esc_html__( 'Hide', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'preservation' ),
			'hidden'  => esc_html__( 'Hidden', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_directions' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'preservation' ),
			'vertical'   => esc_html__( 'Vertical', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'preservation' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'preservation' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'preservation' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'preservation' ),
...
if ( ! function_exists( 'preservation_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'preservation' ),
				'icon'    => esc_html__( 'Icon', 'preservation' ),
				'icons'   => esc_html__( 'Icons', 'preservation' ),
				'zoom'    => esc_html__( 'Zoom', 'preservation' ),
				'fade'    => esc_html__( 'Fade', 'preservation' ),
				'slide'   => esc_html__( 'Slide', 'preservation' ),
				'pull'    => esc_html__( 'Pull', 'preservation' ),
				'border'  => esc_html__( 'Border', 'preservation' ),
				'excerpt' => esc_html__( 'Excerpt', 'preservation' ),
				'info'    => esc_html__( 'Info', 'preservation' ),
			)
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'preservation_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'preservation' ),
				'fullpost' => esc_html__( 'Full post', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'preservation' ),
...
if ( ! function_exists( 'preservation_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = preservation_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			preservation_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = preservation_array_merge( array( 'hide' => preservation_get_not_selected_text( esc_html__( 'Select widgets', 'preservation' ) ) ), $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'preservation' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'preservation' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'preservation' ),
...
if ( ! function_exists( 'preservation_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'preservation' ),
				'below' => esc_html__( 'Below the content', 'preservation' ),
				'float' => esc_html__( 'Floating bar', 'preservation' ),
			)
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'preservation_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'preservation_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'preservation_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'preservation_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'preservation' ),
			'over'    => esc_html__( 'Over', 'preservation' ),
			'under'   => esc_html__( 'Under', 'preservation' ),
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'preservation_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'preservation' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'preservation' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'preservation_filter_allow_fullscreen', $force_fullscreen || preservation_get_theme_setting( 'allow_fullscreen' ) || preservation_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'preservation' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'preservation' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'preservation_filter_list_body_styles', $list );
		return $prepend_inherit
					? preservation_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'preservation_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'preservation_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'preservation' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'preservation' ),
...
if ( ! function_exists( 'preservation_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'preservation' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'preservation' ),
...
if ( ! function_exists( 'preservation_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'preservation' ),
				'date'       => esc_html__( 'Published date', 'preservation' ),
				'modified'   => esc_html__( 'Modified date', 'preservation' ),
				'views'      => esc_html__( 'Views', 'preservation' ),
				'likes'      => esc_html__( 'Likes', 'preservation' ),
				'comments'   => esc_html__( 'Comments', 'preservation' ),
				'share'      => esc_html__( 'Share links', 'preservation' ),
				'categories' => esc_html__( 'Categories', 'preservation' ),
				'edit'       => esc_html__( 'Edit link', 'preservation' ),
			)
		);
...
if ( ! function_exists( 'preservation_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'preservation_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'preservation' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'preservation' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'preservation_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? preservation_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'preservation_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function preservation_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'preservation_filter_list_single_styles', preservation_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? preservation_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'preservation_get_list_categories' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_categories( $prepend_inherit = false ) {
		$list = preservation_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'preservation_filter_term_name', $cat->name, $cat );
				}
			}
			preservation_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_terms' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = preservation_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'preservation_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			preservation_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_posts_types( $prepend_inherit = false ) {
		$list = preservation_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'preservation_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'preservation' ),
				)
			);
			preservation_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_posts' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = preservation_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? preservation_get_not_selected_text( esc_html__( 'Not selected', 'preservation' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			preservation_storage_set( $hash, $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'preservation_get_list_users' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = preservation_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = preservation_get_not_selected_text( esc_html__( 'Not selected', 'preservation' ) );
			$users        = get_users(
				array(
			...
			preservation_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_menus' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_menus( $prepend_inherit = false ) {
		$list = preservation_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'preservation' );
			...
			preservation_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_icons' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'preservation_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = preservation_array_from_list( preservation_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = preservation_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = preservation_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'preservation_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'preservation_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function preservation_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : preservation_parse_icons_classes( preservation_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = preservation_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'preservation_get_list_images' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'preservation_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function preservation_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'preservation_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'preservation' ),
				'link2'   => esc_html__( 'Accent 2', 'preservation' ),
				'link3'   => esc_html__( 'Accent 3', 'preservation' ),
				'dark'    => esc_html__( 'Dark', 'preservation' ),
			)
		);
		return $prepend_inherit ? preservation_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'preservation' ) ), $list ) : $list;
	}
