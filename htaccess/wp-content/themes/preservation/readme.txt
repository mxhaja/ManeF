...
Please install and activate it before starting to use the theme Preservation.
...
Theme documentation is available on https://preservation.themerex.net/doc
...
2) Icons (css/font-icons/*.*)
   The icon set used in Preservation is Fontello.
