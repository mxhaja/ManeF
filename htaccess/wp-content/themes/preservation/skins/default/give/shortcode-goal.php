		...
		<div class="raised">
			...
			if ( 'amount' === $goal_format ) :
				...
				$formatted_goal = give_currency_filter(
     			...
     			echo sprintf(
					...
					__( '<span class="income" data-amounts="%1$s"><span class="income-label">Raised:</span>%2$s</span><span class="goal-text" data-amounts="%3$s"><span class="goal-label">Goal:</span>%4$s</span>', 'preservation' ),
			...
			elseif ( 'percentage' === $goal_format ) :
				...
				echo sprintf( /* translators: %s: percentage of the amount raised compared to the goal target */
					__( '<span class="give-percentage">%s%%</span> funded', 'preservation' ),
					round( $progress )
				);
