...
if ( ! function_exists( 'preservation_booked_get_css' ) ) {
	add_filter( 'preservation_filter_get_css', 'preservation_booked_get_css', 10, 2 );
	function preservation_booked_get_css( $css, $args ) {
