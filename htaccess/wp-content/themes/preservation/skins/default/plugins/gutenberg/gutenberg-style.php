...
if ( ! function_exists( 'preservation_gutenberg_get_css' ) ) {
	add_filter( 'preservation_filter_get_css', 'preservation_gutenberg_get_css', 10, 2 );
	function preservation_gutenberg_get_css( $css, $args ) {
