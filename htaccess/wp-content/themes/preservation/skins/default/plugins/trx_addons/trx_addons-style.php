...
if ( ! function_exists( 'preservation_trx_addons_get_css' ) ) {
	add_filter( 'preservation_filter_get_css', 'preservation_trx_addons_get_css', 10, 2 );
	function preservation_trx_addons_get_css( $css, $args ) {
