...
<div class="author_info author vcard" itemprop="author" itemscope="itemscope" itemtype="<?php echo esc_attr( preservation_get_protocol( true ) ); ?>//schema.org/Person">
	...
	<div class="author_description">
		<h5 class="author_title" itemprop="name"><a class="author_link fn" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><?php
			the_author();
		?></a></h5>
		<div class="author_label"><?php esc_html_e( 'About Author', 'preservation' ); ?></div>
		<div class="author_bio" itemprop="description">
			<?php echo wp_kses( wpautop( get_the_author_meta( 'description' ) ), 'preservation_kses_content' ); ?>
			<div class="author_links">
				<?php do_action( 'preservation_action_user_meta', 'author-bio' ); ?>
			</div>
		</div><!-- .author_bio -->
