...
?><div id="post-<?php the_ID(); ?>" <?php post_class( 'related_item post_format_' . esc_attr( $preservation_post_format ) ); ?> data-post-id="<?php the_ID(); ?>">
	...
	preservation_show_post_featured(
		array(
			'thumb_ratio'   => '300:223',
			'thumb_size'    => apply_filters( 'preservation_filter_related_thumb_size', preservation_get_thumb_size( (int) preservation_get_theme_option( 'related_posts' ) == 1 ? 'huge' : 'square' ) ),
		)
	);
	?>
