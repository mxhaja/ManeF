...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters( 'trx_addons_filter_args_featured', array(
												...
												'thumb_bg' => true,
												'hover' => 'info_anim',
												'thumb_size' => preservation_get_thumb_size('full'),
...
if ( !function_exists( 'preservation_sc_icons_merge_scripts' ) ) {
	add_action("trx_addons_filter_merge_scripts", 'preservation_sc_icons_merge_scripts');
	function preservation_sc_icons_merge_scripts($list) {
